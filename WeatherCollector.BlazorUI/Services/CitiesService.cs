...
namespace WeatherCollector.BlazorUI.Services
{
    public class CitiesService : ICitiesService
    {
        ...
        public CitiesService(IMapper mapper, IRepository<City> cityRepository, AstroWeatherClient client) =>
            (_client, _mapper, _cityRepository) = (client, mapper, cityRepository);
        ...
        {
            var deletedCity = await _cityRepository.Delete(city);
